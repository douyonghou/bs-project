...
public class stuMainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_selfmsg) {
            ...
            Intent intent = new Intent(stuMainActivity.this, YQInfo.class);
            startActivity(intent);
            //今日食谱
        } else if (id == R.id.nav_share) {
            Intent intent = new Intent(stuMainActivity.this, TodayRecipes.class);
            startActivity(intent);
//            活动资讯
        } else if (id == R.id.nav_send) {
            Intent intent = new Intent(stuMainActivity.this, ZXInfo.class);
            startActivity(intent);
        }
