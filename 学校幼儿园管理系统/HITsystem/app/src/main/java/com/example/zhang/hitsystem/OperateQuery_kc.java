...
public class OperateQuery_kc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operate_query_kc);
...
//            Log.d("listlimian", "onCreate: "+scoreList.get(0).toString());
            textView = (TextView)findViewById(R.id.query_midle_kc);
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 0:
                        ...
                        LinearLayoutManager layoutManager = new LinearLayoutManager(OperateQuery_kc.this);
                        recyclerView.setLayoutManager(layoutManager);
                        ScoreAdapter_kc adapter = new ScoreAdapter_kc(scoreList);
                        recyclerView.setAdapter(adapter);
                        break;
                    default:
                        AlertDialog.Builder dialog = new AlertDialog.Builder(OperateQuery_kc.this);
                        dialog.setTitle("错误");
