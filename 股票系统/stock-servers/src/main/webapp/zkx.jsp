...
<form method="post" action="">
	<div id="mainlist" style="align-content: center;width: 1000px">
		<h1>股票信息系统</h1>
		<div class="mainlist">
			<h1>
			...
			<br>
			<tr>
				<img style="width: 100%;higth:110%; align-content: center" src="http://image.sinajs.cn/newchart/weekly/n/sh<%=stockID%>.gif" />
			</tr>
